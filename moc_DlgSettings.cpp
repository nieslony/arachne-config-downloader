...
QT_MOC_LITERAL(1, 12, 20), // "onToggleAutoDownload"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 10), // "saveValues"
QT_MOC_LITERAL(4, 45, 21) // "onDownloadTypeChanged"

    },
    "DlgSettings\0onToggleAutoDownload\0\0"
    "saveValues\0onDownloadTypeChanged"
};
...
void DlgSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onToggleAutoDownload((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->saveValues(); break;
        case 2: _t->onDownloadTypeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
